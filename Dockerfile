...
RUN apt-get install -y php7.4 php7.4-cli php7.4-common php7.4-fpm php7.4-curl php7.4-mbstring php7.4-zip php7.4-simplexml php7.4-soap php7.4-mysql wkhtmltopdf
